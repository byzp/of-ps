class MsgId:
    ...
    ActivitySandbagNotice = 4500
    ActivitySandbagRewardReq = 4501
    ActivitySandbagRewardRsp = 4502
    ActivitySandbagHitReq = 4503
    ActivitySandbagHitRsp = 4504
    ActivitySandbagDropNotice = 4508
    ActivityRecallNotice = 4510
    ActivityRecallRewardClaimReq = 4511
    ActivityRecallRewardClaimRsp = 4512
    RecallCodeUseReq = 4513
    RecallCodeUseRsp = 4514
    ActivityUploadWishTxtReq = 4515
    ActivityUploadWishTxtRsp = 4516
    ActivityKoiNotice = 4518
    ActivityKoiUseItemReq = 4519
    ActivityKoiUseItemRsp = 4520
    TreasureDigReq = 4521
    TreasureDigRsp = 4522
    TreasureIllustrationInfoReq = 4523
    TreasureIllustrationInfoRsp = 4524
    TreasureIllustrationRewardReq = 4525
    TreasureIllustrationRewardRsp = 4526
    GetTreasureAchieveRewardReq = 4527
    GetTreasureAchieveRewardRsp = 4528
    PetCaptureReq = 4531
    PetCaptureRsp = 4532
    PetRenameReq = 4533
    PetRenameRsp = 4534
    PetDecomposeReq = 4535
    PetDecomposeRsp = 4536
    PetWarehouseLimitNotice = 4538
    GetPetReq = 4539
    GetPetRsp = 4540
    ChangePetReq = 4541
    ChangePetRsp = 4542