...
class Handler(PacketHandler):
    def handle(self, session, data: bytes, packet_id: int):
        ...
        json_file_path = os.path.join(os.path.dirname(__file__), '..', 'tmp', 'data', 'GachaRsp.json')
        ...
        for item_data in items_data:
            ...
            if main_item_data:
                ...
                item.main_item.temp_pack_index = main_item_data.get("temp_pack_index", 0)
                ...
                if weapon_data:
                    ...
                    item.main_item.weapon.instance_id = weapon_data.get("instance_id", 0)
                    item.main_item.weapon.attack = weapon_data.get("attack", 0)
                    item.main_item.weapon.damage_balance = weapon_data.get("damage_balance", 0)
                    item.main_item.weapon.critical_ratio = weapon_data.get("critical_ratio", 0)
                    item.main_item.weapon.wearer_id = weapon_data.get("wearer_id", 0)
                    item.main_item.weapon.level = weapon_data.get("level", 0)
                    item.main_item.weapon.strength_level = weapon_data.get("strength_level", 0)
                    item.main_item.weapon.strength_exp = weapon_data.get("strength_exp", 0)
                    item.main_item.weapon.star = weapon_data.get("star", 0)
                    item.main_item.weapon.inscription_1 = weapon_data.get("inscription_1", 0)
                    item.main_item.weapon.durability = weapon_data.get("durability", 0)
                    item.main_item.weapon.property_index = weapon_data.get("property_index", 0)
                    ...
                    for random_property_data in random_properties_data:
                        ...
                        random_property.property_type = random_property_data.get("property_type", 0)
                ...
                if armor_data:
                    ...
                    item.main_item.armor.main_property_type = armor_data.get("main_property_type", 0)
                    item.main_item.armor.main_property_val = armor_data.get("main_property_val", 0)
                    item.main_item.armor.wearer_id = armor_data.get("wearer_id", 0)
                    item.main_item.armor.level = armor_data.get("level", 0)
                    item.main_item.armor.strength_level = armor_data.get("strength_level", 0)
                    item.main_item.armor.strength_exp = armor_data.get("strength_exp", 0)
                    item.main_item.armor.property_index = armor_data.get("property_index", 0)
                ...
                if poster_data:
                    ...
                    item.main_item.poster.instance_id = poster_data.get("instance_id", 0)
                ...
                if character_data:
                    item.main_item.character.character_id = character_data.get("character_id", 0)
                    item.main_item.character.level = character_data.get("level", 0)
                    item.main_item.character.max_level = character_data.get("max_level", 0)
                    item.main_item.character.exp = character_data.get("exp", 0)
                    item.main_item.character.star = character_data.get("star", 0)
                    item.main_item.character.in_use_equipment_preset_index = character_data.get("in_use_equipment_preset_index", 0)
                    item.main_item.character.in_use_outfit_preset_index = character_data.get("in_use_outfit_preset_index", 0)
                    item.main_item.character.gather_weapon = character_data.get("gather_weapon", 0)
                    item.main_item.character.is_unlock_payment = character_data.get("is_unlock_payment", False)
                    
                    # Set character_appearance
                    character_appearance_data = character_data.get("character_appearance", {})
                    if character_appearance_data:
                        item.main_item.character.character_appearance.badge = character_appearance_data.get("badge", 0)
                        item.main_item.character.character_appearance.umbrella_id = character_appearance_data.get("umbrella_id", 0)
                        item.main_item.character.character_appearance.insect_net_instance_id = character_appearance_data.get("insect_net_instance_id", 0)
                        item.main_item.character.character_appearance.logging_axe_instance_id = character_appearance_data.get("logging_axe_instance_id", 0)
                        item.main_item.character.character_appearance.water_bottle_instance_id = character_appearance_data.get("water_bottle_instance_id", 0)
                        item.main_item.character.character_appearance.mining_hammer_instance_id = character_appearance_data.get("mining_hammer_instance_id", 0)
                        item.main_item.character.character_appearance.collection_gloves_instance_id = character_appearance_data.get("collection_gloves_instance_id", 0)
                        item.main_item.character.character_appearance.fishing_rod_instance_id = character_appearance_data.get("fishing_rod_instance_id", 0)
                    ...
                    for equipment_preset_data in equipment_presets_data:
                        equipment_preset = item.main_item.character.equipment_presets.add()
                        equipment_preset.preset_index = equipment_preset_data.get("preset_index", 0)
                    ...
                    for outfit_preset_data in outfit_presets_data:
                        ...
                        outfit_preset.preset_index = outfit_preset_data.get("preset_index", 0)
                        ...
                        outfit_preset.hat_dye_scheme_index = outfit_preset_data.get("hat_dye_scheme_index", 0)
                        outfit_preset.hair_dye_scheme_index = outfit_preset_data.get("hair_dye_scheme_index", 0)
                        outfit_preset.clothes_dye_scheme_index = outfit_preset_data.get("clothes_dye_scheme_index", 0)
                        outfit_preset.ornament_dye_scheme_index = outfit_preset_data.get("ornament_dye_scheme_index", 0)
                    
                    # Set character_skill_list
                    character_skill_list_data = character_data.get("character_skill_list", [])
                    for character_skill_data in character_skill_list_data:
                        character_skill = item.main_item.character.character_skill_list.add()
                        character_skill.skill_id = character_skill_data.get("skill_id", 0)
                        character_skill.skill_level = character_skill_data.get("skill_level", 0)
                    
                    # Set rewarded_achievement_id_lst
                    rewarded_achievement_id_lst_data = character_data.get("rewarded_achievement_id_lst", [])
                    for achievement_id in rewarded_achievement_id_lst_data:
                        item.main_item.character.rewarded_achievement_id_lst.append(achievement_id)
                ...
                if inscription_data:
                    item.main_item.inscription.inscription_id = inscription_data.get("inscription_id", 0)
                    item.main_item.inscription.level = inscription_data.get("level", 0)
                    item.main_item.inscription.weapon_instance_id = inscription_data.get("weapon_instance_id", 0)
            ...
            for transformed_item_data in transformed_items_data:
                ...
                transformed_item.temp_pack_index = transformed_item_data.get("temp_pack_index", 0)
                
                # Set base_item
                base_item_data = transformed_item_data.get("base_item", {})
                if base_item_data:
                    transformed_item.base_item.item_id = base_item_data.get("item_id", 0)
                ...
                if weapon_data:
                    ...
                    transformed_item.weapon.instance_id = weapon_data.get("instance_id", 0)
                    transformed_item.weapon.attack = weapon_data.get("attack", 0)
                    transformed_item.weapon.damage_balance = weapon_data.get("damage_balance", 0)
                    transformed_item.weapon.critical_ratio = weapon_data.get("critical_ratio", 0)
                    transformed_item.weapon.wearer_id = weapon_data.get("wearer_id", 0)
                    transformed_item.weapon.level = weapon_data.get("level", 0)
                    transformed_item.weapon.strength_level = weapon_data.get("strength_level", 0)
                    transformed_item.weapon.strength_exp = weapon_data.get("strength_exp", 0)
                    transformed_item.weapon.star = weapon_data.get("star", 0)
                    transformed_item.weapon.inscription_1 = weapon_data.get("inscription_1", 0)
                    transformed_item.weapon.durability = weapon_data.get("durability", 0)
                    transformed_item.weapon.property_index = weapon_data.get("property_index", 0)
                ...
                if armor_data:
                    ...
                    transformed_item.armor.instance_id = armor_data.get("instance_id", 0)
                    transformed_item.armor.main_property_type = armor_data.get("main_property_type", 0)
                    transformed_item.armor.main_property_val = armor_data.get("main_property_val", 0)
                    transformed_item.armor.wearer_id = armor_data.get("wearer_id", 0)
                    transformed_item.armor.level = armor_data.get("level", 0)
                    transformed_item.armor.strength_level = armor_data.get("strength_level", 0)
                    transformed_item.armor.strength_exp = armor_data.get("strength_exp", 0)
                    transformed_item.armor.property_index = armor_data.get("property_index", 0)
                ...
                if poster_data:
                    ...
                    transformed_item.poster.instance_id = poster_data.get("instance_id", 0)
                ...
                if character_data:
                    transformed_item.character.character_id = character_data.get("character_id", 0)
                    transformed_item.character.level = character_data.get("level", 0)
                    transformed_item.character.max_level = character_data.get("max_level", 0)
                    transformed_item.character.exp = character_data.get("exp", 0)
                    transformed_item.character.star = character_data.get("star", 0)
                    transformed_item.character.in_use_equipment_preset_index = character_data.get("in_use_equipment_preset_index", 0)
                    transformed_item.character.in_use_outfit_preset_index = character_data.get("in_use_outfit_preset_index", 0)
                    transformed_item.character.gather_weapon = character_data.get("gather_weapon", 0)
                    transformed_item.character.is_unlock_payment = character_data.get("is_unlock_payment", False)
                    
                    # Set character_appearance
                    character_appearance_data = character_data.get("character_appearance", {})
                    if character_appearance_data:
                        transformed_item.character.character_appearance.badge = character_appearance_data.get("badge", 0)
                        transformed_item.character.character_appearance.umbrella_id = character_appearance_data.get("umbrella_id", 0)
                        transformed_item.character.character_appearance.insect_net_instance_id = character_appearance_data.get("insect_net_instance_id", 0)
                        transformed_item.character.character_appearance.logging_axe_instance_id = character_appearance_data.get("logging_axe_instance_id", 0)
                        transformed_item.character.character_appearance.water_bottle_instance_id = character_appearance_data.get("water_bottle_instance_id", 0)
                        transformed_item.character.character_appearance.mining_hammer_instance_id = character_appearance_data.get("mining_hammer_instance_id", 0)
                        transformed_item.character.character_appearance.collection_gloves_instance_id = character_appearance_data.get("collection_gloves_instance_id", 0)
                        transformed_item.character.character_appearance.fishing_rod_instance_id = character_appearance_data.get("fishing_rod_instance_id", 0)
                    
                    # Set equipment_presets
                    equipment_presets_data = character_data.get("equipment_presets", [])
                    for equipment_preset_data in equipment_presets_data:
                        equipment_preset = transformed_item.character.equipment_presets.add()
                        equipment_preset.preset_index = equipment_preset_data.get("preset_index", 0)
                        equipment_preset.weapon = equipment_preset_data.get("weapon", 0)
                    ...
                    character_skill_list_data = character_data.get("character_skill_list", [])
                    for character_skill_data in character_skill_list_data:
                        character_skill = transformed_item.character.character_skill_list.add()
                        character_skill.skill_id = character_skill_data.get("skill_id", 0)
                        character_skill.skill_level = character_skill_data.get("skill_level", 0)
                    ...
                    rewarded_achievement_id_lst_data = character_data.get("rewarded_achievement_id_lst", [])
                    for achievement_id in rewarded_achievement_id_lst_data:
                        transformed_item.character.rewarded_achievement_id_lst.append(achievement_id)
                ...
                if inscription_data:
                    transformed_item.inscription.inscription_id = inscription_data.get("inscription_id", 0)
                    transformed_item.inscription.level = inscription_data.get("level", 0)
                    transformed_item.inscription.weapon_instance_id = inscription_data.get("weapon_instance_id", 0)
            ...
            for extra_data in extras_data:
                ...
                if armor_data:
                    ...
                    extra.armor.main_property_type = armor_data.get("main_property_type", 0)
                    extra.armor.main_property_val = armor_data.get("main_property_val", 0)
                ...
                if character_data:
                    ...
                    extra.character.in_use_equipment_preset_index = character_data.get("in_use_equipment_preset_index", 0)
                    extra.character.in_use_outfit_preset_index = character_data.get("in_use_outfit_preset_index", 0)
                    extra.character.gather_weapon = character_data.get("gather_weapon", 0)
                    extra.character.is_unlock_payment = character_data.get("is_unlock_payment", False)
                    
                    # Set character_appearance
                    character_appearance_data = character_data.get("character_appearance", {})
                    if character_appearance_data:
                        extra.character.character_appearance.badge = character_appearance_data.get("badge", 0)
                        extra.character.character_appearance.umbrella_id = character_appearance_data.get("umbrella_id", 0)
                        extra.character.character_appearance.insect_net_instance_id = character_appearance_data.get("insect_net_instance_id", 0)
                        extra.character.character_appearance.logging_axe_instance_id = character_appearance_data.get("logging_axe_instance_id", 0)
                        extra.character.character_appearance.water_bottle_instance_id = character_appearance_data.get("water_bottle_instance_id", 0)
                        extra.character.character_appearance.mining_hammer_instance_id = character_appearance_data.get("mining_hammer_instance_id", 0)
                        extra.character.character_appearance.collection_gloves_instance_id = character_appearance_data.get("collection_gloves_instance_id", 0)
                        extra.character.character_appearance.fishing_rod_instance_id = character_appearance_data.get("fishing_rod_instance_id", 0)
                    ...
                    rewarded_achievement_id_lst_data = character_data.get("rewarded_achievement_id_lst", [])
                    for achievement_id in rewarded_achievement_id_lst_data:
                        extra.character.rewarded_achievement_id_lst.append(achievement_id)
                ...
                if inscription_data:
                    extra.inscription.inscription_id = inscription_data.get("inscription_id", 0)
                    extra.inscription.level = inscription_data.get("level", 0)
                    extra.inscription.weapon_instance_id = inscription_data.get("weapon_instance_id", 0)
