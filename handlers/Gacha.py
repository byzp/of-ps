...
class Handler(PacketHandler):
    def handle(self, session, data: bytes, packet_id: int):
        ...
        for main_item_data in TEST_DATA["main_items"]:
            ...
            item_detail.main_item.base_item.item_id = main_item_data["base_item"]["item_id"]
            item_detail.main_item.base_item.num = main_item_data["base_item"]["num"]
            
            # Set character if available
            if "character" in main_item_data and "character_id" in main_item_data["character"]:
                item_detail.main_item.character.character_id = main_item_data["character"]["character_id"]
