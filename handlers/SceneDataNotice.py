...
class Handler(PacketHandler):
    def handle(self, session, data: bytes, packet_id: int):
        ...
        json_file_path = os.path.join(os.path.dirname(__file__), '..', 'tmp', 'data', 'SceneDataNotice.json')
        ...
        if data_obj:
            ...
            for gather_limit_data in data_obj.get("gather_limits", []):
                ...
                gather_limit.gather_limit_num = gather_limit_data.get("gather_limit_num", 0)
                gather_limit.lucky_gather_limit_num = gather_limit_data.get("lucky_gather_limit_num", 0)
            ...
            for treasure_box_data in data_obj.get("treasure_boxes", []):
                ...
                treasure_box.next_refresh_time = treasure_box_data.get("next_refresh_time", 0)
            ...
            if garden_data:
                ...
                rsp.data.garden_data.access_player_num = garden_data.get("access_player_num", 0)
                ...
                rsp.data.garden_data.furniture_current_point_num = garden_data.get("furniture_current_point_num", 0)
                ...
                if team_data:
                    ...
                    if char_1_data:
                        ...
                        if outfit_preset_data:
                            player.team.char_1.outfit_preset.hat = outfit_preset_data.get("hat", 0)
                            player.team.char_1.outfit_preset.hair = outfit_preset_data.get("hair", 0)
                            player.team.char_1.outfit_preset.clothes = outfit_preset_data.get("clothes", 0)
                            player.team.char_1.outfit_preset.ornament = outfit_preset_data.get("ornament", 0)
                            
                            # hat_dye_scheme
                            hat_dye_scheme_data = outfit_preset_data.get("hat_dye_scheme", {})
                            if hat_dye_scheme_data:
                                player.team.char_1.outfit_preset.hat_dye_scheme.scheme_index = hat_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_1.outfit_preset.hat_dye_scheme.is_un_lock = hat_dye_scheme_data.get("is_un_lock", False)
                                # colors are empty in this case
                            
                            # hair_dye_scheme
                            hair_dye_scheme_data = outfit_preset_data.get("hair_dye_scheme", {})
                            if hair_dye_scheme_data:
                                player.team.char_1.outfit_preset.hair_dye_scheme.scheme_index = hair_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_1.outfit_preset.hair_dye_scheme.is_un_lock = hair_dye_scheme_data.get("is_un_lock", False)
                                # colors are empty in this case
                            
                            # cloth_dye_scheme
                            cloth_dye_scheme_data = outfit_preset_data.get("cloth_dye_scheme", {})
                            if cloth_dye_scheme_data:
                                player.team.char_1.outfit_preset.cloth_dye_scheme.scheme_index = cloth_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_1.outfit_preset.cloth_dye_scheme.is_un_lock = cloth_dye_scheme_data.get("is_un_lock", False)
                                # colors are empty in this case
                            
                            # orn_dye_scheme
                            orn_dye_scheme_data = outfit_preset_data.get("orn_dye_scheme", {})
                            if orn_dye_scheme_data:
                                player.team.char_1.outfit_preset.orn_dye_scheme.scheme_index = orn_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_1.outfit_preset.orn_dye_scheme.is_un_lock = orn_dye_scheme_data.get("is_un_lock", False)
                                # colors are empty in this case
                            
                            # hide_info
                            hide_info_data = outfit_preset_data.get("hide_info", {})
                            if hide_info_data:
                                player.team.char_1.outfit_preset.hide_info.hide_orn = hide_info_data.get("hide_orn", False)
                                player.team.char_1.outfit_preset.hide_info.hide_braid = hide_info_data.get("hide_braid", False)
                            
                            player.team.char_1.outfit_preset.pend_top = outfit_preset_data.get("pend_top", 0)
                            player.team.char_1.outfit_preset.pend_chest = outfit_preset_data.get("pend_chest", 0)
                            player.team.char_1.outfit_preset.pend_pelvis = outfit_preset_data.get("pend_pelvis", 0)
                            player.team.char_1.outfit_preset.pend_up_face = outfit_preset_data.get("pend_up_face", 0)
                            player.team.char_1.outfit_preset.pend_down_face = outfit_preset_data.get("pend_down_face", 0)
                            player.team.char_1.outfit_preset.pend_left_hand = outfit_preset_data.get("pend_left_hand", 0)
                            player.team.char_1.outfit_preset.pend_right_hand = outfit_preset_data.get("pend_right_hand", 0)
                            player.team.char_1.outfit_preset.pend_left_foot = outfit_preset_data.get("pend_left_foot", 0)
                            player.team.char_1.outfit_preset.pend_right_foot = outfit_preset_data.get("pend_right_foot", 0)
                            ...
                            if pend_chest_dye_scheme_data:
                                player.team.char_1.outfit_preset.pend_chest_dye_scheme.scheme_index = pend_chest_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_1.outfit_preset.pend_chest_dye_scheme.is_un_lock = pend_chest_dye_scheme_data.get("is_un_lock", False)
                                # colors are empty in this case
                        
                        player.team.char_1.gather_weapon = char_1_data.get("gather_weapon", 0)
                        
                        # Set character_appearance
                        character_appearance_data = char_1_data.get("character_appearance", {})
                        if character_appearance_data:
                            player.team.char_1.character_appearance.badge = character_appearance_data.get("badge", 0)
                            player.team.char_1.character_appearance.umbrella_id = character_appearance_data.get("umbrella_id", 0)
                            player.team.char_1.character_appearance.insect_net_instance_id = character_appearance_data.get("insect_net_instance_id", 0)
                            player.team.char_1.character_appearance.logging_axe_instance_id = character_appearance_data.get("logging_axe_instance_id", 0)
                            player.team.char_1.character_appearance.water_bottle_instance_id = character_appearance_data.get("water_bottle_instance_id", 0)
                            player.team.char_1.character_appearance.mining_hammer_instance_id = character_appearance_data.get("mining_hammer_instance_id", 0)
                            player.team.char_1.character_appearance.collection_gloves_instance_id = character_appearance_data.get("collection_gloves_instance_id", 0)
                            player.team.char_1.character_appearance.fishing_rod_instance_id = character_appearance_data.get("fishing_rod_instance_id", 0)
                        ...
                        if pos_data:
                            ...
                            player.team.char_1.pos.decimal_places = pos_data.get("decimal_places", 0)
                        ...
                        if rot_data:
                            ...
                            player.team.char_1.rot.decimal_places = rot_data.get("decimal_places", 0)
                        
                        player.team.char_1.weapon_id = char_1_data.get("weapon_id", 0)
                        player.team.char_1.weapon_star = char_1_data.get("weapon_star", 0)
                        ...
                        player.team.char_1.char_break_lv = char_1_data.get("char_break_lv", 0)
                        ...
                        player.team.char_1.inscription_id = char_1_data.get("inscription_id", 0)
                        player.team.char_1.inscription_lv = char_1_data.get("inscription_lv", 0)
                    ...
                    if char_2_data:
                        ...
                        if outfit_preset_data:
                            player.team.char_2.outfit_preset.hat = outfit_preset_data.get("hat", 0)
                            player.team.char_2.outfit_preset.hair = outfit_preset_data.get("hair", 0)
                            player.team.char_2.outfit_preset.clothes = outfit_preset_data.get("clothes", 0)
                            player.team.char_2.outfit_preset.ornament = outfit_preset_data.get("ornament", 0)
                            
                            # hat_dye_scheme
                            hat_dye_scheme_data = outfit_preset_data.get("hat_dye_scheme", {})
                            if hat_dye_scheme_data:
                                player.team.char_2.outfit_preset.hat_dye_scheme.scheme_index = hat_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_2.outfit_preset.hat_dye_scheme.is_un_lock = hat_dye_scheme_data.get("is_un_lock", False)
                            
                            # hair_dye_scheme
                            hair_dye_scheme_data = outfit_preset_data.get("hair_dye_scheme", {})
                            if hair_dye_scheme_data:
                                player.team.char_2.outfit_preset.hair_dye_scheme.scheme_index = hair_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_2.outfit_preset.hair_dye_scheme.is_un_lock = hair_dye_scheme_data.get("is_un_lock", False)
                            
                            # cloth_dye_scheme
                            cloth_dye_scheme_data = outfit_preset_data.get("cloth_dye_scheme", {})
                            if cloth_dye_scheme_data:
                                player.team.char_2.outfit_preset.cloth_dye_scheme.scheme_index = cloth_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_2.outfit_preset.cloth_dye_scheme.is_un_lock = cloth_dye_scheme_data.get("is_un_lock", False)
                            
                            # orn_dye_scheme
                            orn_dye_scheme_data = outfit_preset_data.get("orn_dye_scheme", {})
                            if orn_dye_scheme_data:
                                player.team.char_2.outfit_preset.orn_dye_scheme.scheme_index = orn_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_2.outfit_preset.orn_dye_scheme.is_un_lock = orn_dye_scheme_data.get("is_un_lock", False)
                            
                            # hide_info
                            hide_info_data = outfit_preset_data.get("hide_info", {})
                            if hide_info_data:
                                player.team.char_2.outfit_preset.hide_info.hide_orn = hide_info_data.get("hide_orn", False)
                                player.team.char_2.outfit_preset.hide_info.hide_braid = hide_info_data.get("hide_braid", False)
                            
                            player.team.char_2.outfit_preset.pend_top = outfit_preset_data.get("pend_top", 0)
                            player.team.char_2.outfit_preset.pend_chest = outfit_preset_data.get("pend_chest", 0)
                            player.team.char_2.outfit_preset.pend_pelvis = outfit_preset_data.get("pend_pelvis", 0)
                            player.team.char_2.outfit_preset.pend_up_face = outfit_preset_data.get("pend_up_face", 0)
                            player.team.char_2.outfit_preset.pend_down_face = outfit_preset_data.get("pend_down_face", 0)
                            player.team.char_2.outfit_preset.pend_left_hand = outfit_preset_data.get("pend_left_hand", 0)
                            player.team.char_2.outfit_preset.pend_right_hand = outfit_preset_data.get("pend_right_hand", 0)
                            player.team.char_2.outfit_preset.pend_left_foot = outfit_preset_data.get("pend_left_foot", 0)
                            player.team.char_2.outfit_preset.pend_right_foot = outfit_preset_data.get("pend_right_foot", 0)
                            
                            # pend_chest_dye_scheme
                            pend_chest_dye_scheme_data = outfit_preset_data.get("pend_chest_dye_scheme", {})
                            if pend_chest_dye_scheme_data:
                                player.team.char_2.outfit_preset.pend_chest_dye_scheme.scheme_index = pend_chest_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_2.outfit_preset.pend_chest_dye_scheme.is_un_lock = pend_chest_dye_scheme_data.get("is_un_lock", False)
                        
                        player.team.char_2.gather_weapon = char_2_data.get("gather_weapon", 0)
                        
                        # Set character_appearance
                        character_appearance_data = char_2_data.get("character_appearance", {})
                        if character_appearance_data:
                            player.team.char_2.character_appearance.badge = character_appearance_data.get("badge", 0)
                            player.team.char_2.character_appearance.umbrella_id = character_appearance_data.get("umbrella_id", 0)
                            player.team.char_2.character_appearance.insect_net_instance_id = character_appearance_data.get("insect_net_instance_id", 0)
                            player.team.char_2.character_appearance.logging_axe_instance_id = character_appearance_data.get("logging_axe_instance_id", 0)
                            player.team.char_2.character_appearance.water_bottle_instance_id = character_appearance_data.get("water_bottle_instance_id", 0)
                            player.team.char_2.character_appearance.mining_hammer_instance_id = character_appearance_data.get("mining_hammer_instance_id", 0)
                            player.team.char_2.character_appearance.collection_gloves_instance_id = character_appearance_data.get("collection_gloves_instance_id", 0)
                            player.team.char_2.character_appearance.fishing_rod_instance_id = character_appearance_data.get("fishing_rod_instance_id", 0)
                        ...
                        if pos_data:
                            ...
                            player.team.char_2.pos.decimal_places = pos_data.get("decimal_places", 0)
                        ...
                        if rot_data:
                            ...
                            player.team.char_2.rot.decimal_places = rot_data.get("decimal_places", 0)
                        
                        player.team.char_2.weapon_id = char_2_data.get("weapon_id", 0)
                        player.team.char_2.weapon_star = char_2_data.get("weapon_star", 0)
                        ...
                        player.team.char_2.char_break_lv = char_2_data.get("char_break_lv", 0)
                        ...
                        player.team.char_2.inscription_id = char_2_data.get("inscription_id", 0)
                        player.team.char_2.inscription_lv = char_2_data.get("inscription_lv", 0)
                    ...
                    if char_3_data:
                        ...
                        if outfit_preset_data:
                            player.team.char_3.outfit_preset.hat = outfit_preset_data.get("hat", 0)
                            player.team.char_3.outfit_preset.hair = outfit_preset_data.get("hair", 0)
                            player.team.char_3.outfit_preset.clothes = outfit_preset_data.get("clothes", 0)
                            player.team.char_3.outfit_preset.ornament = outfit_preset_data.get("ornament", 0)
                            
                            # hat_dye_scheme
                            hat_dye_scheme_data = outfit_preset_data.get("hat_dye_scheme", {})
                            if hat_dye_scheme_data:
                                player.team.char_3.outfit_preset.hat_dye_scheme.scheme_index = hat_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_3.outfit_preset.hat_dye_scheme.is_un_lock = hat_dye_scheme_data.get("is_un_lock", False)
                            
                            # hair_dye_scheme
                            hair_dye_scheme_data = outfit_preset_data.get("hair_dye_scheme", {})
                            if hair_dye_scheme_data:
                                player.team.char_3.outfit_preset.hair_dye_scheme.scheme_index = hair_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_3.outfit_preset.hair_dye_scheme.is_un_lock = hair_dye_scheme_data.get("is_un_lock", False)
                            
                            # cloth_dye_scheme
                            cloth_dye_scheme_data = outfit_preset_data.get("cloth_dye_scheme", {})
                            if cloth_dye_scheme_data:
                                player.team.char_3.outfit_preset.cloth_dye_scheme.scheme_index = cloth_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_3.outfit_preset.cloth_dye_scheme.is_un_lock = cloth_dye_scheme_data.get("is_un_lock", False)
                            
                            # orn_dye_scheme
                            orn_dye_scheme_data = outfit_preset_data.get("orn_dye_scheme", {})
                            if orn_dye_scheme_data:
                                player.team.char_3.outfit_preset.orn_dye_scheme.scheme_index = orn_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_3.outfit_preset.orn_dye_scheme.is_un_lock = orn_dye_scheme_data.get("is_un_lock", False)
                            
                            # hide_info
                            hide_info_data = outfit_preset_data.get("hide_info", {})
                            if hide_info_data:
                                player.team.char_3.outfit_preset.hide_info.hide_orn = hide_info_data.get("hide_orn", False)
                                player.team.char_3.outfit_preset.hide_info.hide_braid = hide_info_data.get("hide_braid", False)
                            
                            player.team.char_3.outfit_preset.pend_top = outfit_preset_data.get("pend_top", 0)
                            player.team.char_3.outfit_preset.pend_chest = outfit_preset_data.get("pend_chest", 0)
                            player.team.char_3.outfit_preset.pend_pelvis = outfit_preset_data.get("pend_pelvis", 0)
                            player.team.char_3.outfit_preset.pend_up_face = outfit_preset_data.get("pend_up_face", 0)
                            player.team.char_3.outfit_preset.pend_down_face = outfit_preset_data.get("pend_down_face", 0)
                            player.team.char_3.outfit_preset.pend_left_hand = outfit_preset_data.get("pend_left_hand", 0)
                            player.team.char_3.outfit_preset.pend_right_hand = outfit_preset_data.get("pend_right_hand", 0)
                            player.team.char_3.outfit_preset.pend_left_foot = outfit_preset_data.get("pend_left_foot", 0)
                            player.team.char_3.outfit_preset.pend_right_foot = outfit_preset_data.get("pend_right_foot", 0)
                            
                            # pend_chest_dye_scheme
                            pend_chest_dye_scheme_data = outfit_preset_data.get("pend_chest_dye_scheme", {})
                            if pend_chest_dye_scheme_data:
                                player.team.char_3.outfit_preset.pend_chest_dye_scheme.scheme_index = pend_chest_dye_scheme_data.get("scheme_index", 0)
                                player.team.char_3.outfit_preset.pend_chest_dye_scheme.is_un_lock = pend_chest_dye_scheme_data.get("is_un_lock", False)
                        
                        player.team.char_3.gather_weapon = char_3_data.get("gather_weapon", 0)
                        
                        # Set character_appearance
                        character_appearance_data = char_3_data.get("character_appearance", {})
                        if character_appearance_data:
                            player.team.char_3.character_appearance.badge = character_appearance_data.get("badge", 0)
                            player.team.char_3.character_appearance.umbrella_id = character_appearance_data.get("umbrella_id", 0)
                            player.team.char_3.character_appearance.insect_net_instance_id = character_appearance_data.get("insect_net_instance_id", 0)
                            player.team.char_3.character_appearance.logging_axe_instance_id = character_appearance_data.get("logging_axe_instance_id", 0)
                            player.team.char_3.character_appearance.water_bottle_instance_id = character_appearance_data.get("water_bottle_instance_id", 0)
                            player.team.char_3.character_appearance.mining_hammer_instance_id = character_appearance_data.get("mining_hammer_instance_id", 0)
                            player.team.char_3.character_appearance.collection_gloves_instance_id = character_appearance_data.get("collection_gloves_instance_id", 0)
                            player.team.char_3.character_appearance.fishing_rod_instance_id = character_appearance_data.get("fishing_rod_instance_id", 0)
                        ...
                        if pos_data:
                            ...
                            player.team.char_3.pos.decimal_places = pos_data.get("decimal_places", 0)
                        ...
                        if rot_data:
                            ...
                            player.team.char_3.rot.decimal_places = rot_data.get("decimal_places", 0)
                        
                        player.team.char_3.weapon_id = char_3_data.get("weapon_id", 0)
                        player.team.char_3.weapon_star = char_3_data.get("weapon_star", 0)
                        ...
                        player.team.char_3.char_break_lv = char_3_data.get("char_break_lv", 0)
                        ...
                        player.team.char_3.inscription_id = char_3_data.get("inscription_id", 0)
                        player.team.char_3.inscription_lv = char_3_data.get("inscription_lv", 0)
            ...
            if scene_garden_data:
                ...
                garden_furniture_info_map = scene_garden_data.get("garden_furniture_info_map", {})
                ...
                if isinstance(garden_furniture_info_map, dict):
                    for key, value in garden_furniture_info_map.items():
                        furniture_details = rsp.data.scene_garden_data.garden_furniture_info_map[key]
                        ...
                        furniture_details.pos.decimal_places = value.get("pos", {}).get("decimal_places", 0)
                        furniture_details.rotation.x = value.get("rotation", {}).get("x", 0)
                        furniture_details.rotation.y = value.get("rotation", {}).get("y", 0)
                        furniture_details.rotation.z = value.get("rotation", {}).get("z", 0)
                        furniture_details.rotation.decimal_places = value.get("rotation", {}).get("decimal_places", 0)
                
                rsp.data.scene_garden_data.likes_num = scene_garden_data.get("likes_num", 0)
                rsp.data.scene_garden_data.access_player_num = scene_garden_data.get("access_player_num", 0)
                rsp.data.scene_garden_data.left_like_num = scene_garden_data.get("left_like_num", 0)
                rsp.data.scene_garden_data.garden_name = scene_garden_data.get("garden_name", "")
                rsp.data.scene_garden_data.furniture_current_point_num = scene_garden_data.get("furniture_current_point_num", 0)
                ...
                other_player_furniture_info_map = scene_garden_data.get("other_player_furniture_info_map", {})
                ...
                if isinstance(other_player_furniture_info_map, dict):
                    for key, value in other_player_furniture_info_map.items():
                        rsp.data.scene_garden_data.other_player_furniture_info_map[key] = value
                
                # Set player_handing_furniture_info_map (empty in this case)
                # No player handing furniture info in the sample data
                player_handing_furniture_info_map = scene_garden_data.get("player_handing_furniture_info_map", {})
                ...
                if isinstance(player_handing_furniture_info_map, dict):
                    for key, value in player_handing_furniture_info_map.items():
                        rsp.data.scene_garden_data.player_handing_furniture_info_map[key] = value
            ...
            for camp_fire_data in data_obj.get("camp_fires", []):
                ...
                camp_fire.pos.decimal_places = camp_fire_data.get("pos", {}).get("decimal_places", 0)
                ...
                camp_fire.rot.decimal_places = camp_fire_data.get("rot", {}).get("decimal_places", 0)
            ...
            if fireworks_info_data:
                rsp.data.fireworks_info.fireworks_id = fireworks_info_data.get("fireworks_id", 0)
                rsp.data.fireworks_info.fireworks_duration_time = fireworks_info_data.get("fireworks_duration_time", 0)
                rsp.data.fireworks_info.fireworks_start_time = fireworks_info_data.get("fireworks_start_time", 0)
            ...
            for mp_beacon_data in data_obj.get("mp_beacons", []):
                ...
                mp_beacon.position.decimal_places = mp_beacon_data.get("position", {}).get("decimal_places", 0)
                ...
                mp_beacon.rotation.decimal_places = mp_beacon_data.get("rotation", {}).get("decimal_places", 0)
                mp_beacon.count_down_from_sec = mp_beacon_data.get("count_down_from_sec", 0)
            ...
            for placed_character_data in data_obj.get("placed_characters", []):
                ...
                placed_character.character_id = placed_character_data.get("character_id", 0)
            ...
            for moon_spot_data in data_obj.get("moon_spots", []):
                ...
                moon_spot.pos.decimal_places = moon_spot_data.get("pos", {}).get("decimal_places", 0)
                ...
                moon_spot.rot.decimal_places = moon_spot_data.get("rot", {}).get("decimal_places", 0)
            ...
            for drop_item_data in data_obj.get("drop_items", []):
                ...
                if isinstance(items_data, list):
                    for item_data in items_data:
                        ...
                        if main_prop_data:
                            item.main_prop.prop_type = main_prop_data.get("prop_type", 0)
                            item.main_prop.prop_value = main_prop_data.get("prop_value", 0)
            ...
            if soccer_position_data:
                rsp.data.soccer_position.position.x = soccer_position_data.get("position", {}).get("x", 0)
                rsp.data.soccer_position.position.y = soccer_position_data.get("position", {}).get("y", 0)
                rsp.data.soccer_position.position.z = soccer_position_data.get("position", {}).get("z", 0)
                rsp.data.soccer_position.position.decimal_places = soccer_position_data.get("position", {}).get("decimal_places", 0)
            ...
            for dungeon_data in data_obj.get("dungeons", []):
                ...
                dungeon.is_open_secret_box = dungeon_data.get("is_open_secret_box", False)
            ...
            rsp.data.current_gather_group_id = data_obj.get("current_gather_group_id", 0)
