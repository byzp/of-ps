...
class DispatchHandler:
    ...
    @staticmethod
    def region_info():
        return '{"status":true,"message":"success","gate_tcp_ip":"'+Config.GAME_SERVER_IP+'","gate_tcp_port":11033,"is_server_open":true,"text":"","client_log_tcp_ip":"192.168.31.149","client_log_tcp_port":21006,"currentVersion":"2025-09-19-16-44-33_2025-09-29-11-44-13","photo_share_cdn_url":"https://cdn-photo-of.inutan.com/cn_prod_main"}'
